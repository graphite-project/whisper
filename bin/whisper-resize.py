...
def main():
    ...
    resize(path, retentions, **vars(options))


def resize(path, retentions, xFilesFactor=None, aggregationMethod=None, force=False,
           newfile=None, nobackup=False, aggregate=False):
