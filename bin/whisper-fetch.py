...
def main():
    ...
    fetch(path, **vars(options))


def fetch(path, from_time, until_time, json_output=False, pretty=False,
          time_format=None, drop=None):
    try:
